...
public class PrintNumOnly {
	...
	public static void main(String[] args) {
		...
		char[] charArray = details.toCharArray(); // To split the string into single characters
		for (int i = 0; i < charArray.length; i++) {
			// To print the numbers only using ASCII VALUES of the numbers
			if(charArray[i]>=48 && charArray[i]<=58) {
				// if you use println, it will take you to the next line instead use print for printing the output on the same line
